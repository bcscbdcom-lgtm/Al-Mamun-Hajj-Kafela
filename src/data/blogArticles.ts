...
export const testimonialsData: Testimonial[] = [
  ...
  },
  {
    ...
    locationEn: 'Khulna Sadar',
    locationBn: 'খুলনা সদর',
    rating: 5,
    packageTypeEn: 'VIP Luxury Hajj (Clock Tower)',
    packageTypeBn: 'ভিআইপি লাক্সারি হজ (ক্লক টাওয়ার)',
    year: '2024',
    textEn: 'The Clock Tower hotel overlooking the Kaaba was an unforgettable spiritual highlight. The Haramain bullet train journey was seamless. Mufti Amanullah guided every step with great wisdom.',
    textBn: 'ক্লক টাওয়ারের কাবা ভিউ রুম থেকে নামাজ আদায়ের অনুভূতি ভাষায় প্রকাশ করার মতো নয়। বুলেট ট্রেনে আরামদায়ক যাতায়াত এবং মুফতী আমানুল্লাহ সাহেবের সার্বক্ষণিক দিকনির্দেশনা আমাদের পরিবারকে নিশ্চিন্ত রেখেছিল।'
  },
  {
    id: 'test-4',
...
১০. **আইডি কার্ড সার্বক্ষণিক পরিধান**: আল মামুন হজ্ব কাফেলার পরিচয়পত্র ও হোটেলের কার্ড সবসময় সঙ্গে রাখুন।`
  },
  {
